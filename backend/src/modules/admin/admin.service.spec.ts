...
describe('AdminService', () => {
  ...
  describe('getPayments', () => {
    it('필터 없이 페이지 1 기본값으로 조회', async () => {
      ...
      const result = await service.getPayments({} as any);
    ...
    it('페이지 2일 때 skip 계산 정확성', async () => {
      ...
      await service.getPayments({ page: 2, limit: 10 } as any);
    ...
    it('totalPages 올림 계산', async () => {
      ...
      const result = await service.getPayments({ limit: 10 } as any);
  ...
  describe('getMatchLogs', () => {
    it('매칭 로그 페이징 반환', async () => {
      ...
      const result = await service.getMatchLogs({} as any);
  ...
  describe('getAuditLogs', () => {
    ...
    it('감사 로그 데이터 반환', async () => {
      ...
      const result = await service.getAuditLogs({ entityId: 'p1' } as any);
