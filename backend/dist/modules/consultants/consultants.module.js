...
exports.ConsultantsModule = ConsultantsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: consultant_request_schema_1.ConsultantRequest.name, schema: consultant_request_schema_1.ConsultantRequestSchema }]),
        ],
