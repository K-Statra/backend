...
const company_images_controller_1 = require("./company-images.controller");
...
exports.CompaniesModule = CompaniesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [companies_controller_1.CompaniesController, company_images_controller_1.CompanyImagesController],
        providers: [companies_service_1.CompaniesService, company_images_service_1.CompanyImagesService],
